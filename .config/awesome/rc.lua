...
beautiful.init("/home/kdb424/.config/awesome/theme.lua")
...
-- Set padding on bottom for conky reserved
for s=1, screen.count() do
	awful.screen.padding(screen[s],{bottom=18})
end
...
globalkeys = awful.util.table.join(
    ...
    -- Lockscreen
    awful.key({ modkey}, "l", function () awful.util.spawn("/usr/bin/i3lock -uef") end),
...
run_once("albert")
run_once("urxvtd")
run_once("sleep .1 && nitrogen --restore")
run_once("xset s off -dpms")
run_once("autocutsel -selection PRIMARY -fork")
run_once("autocutsel -selection CLIPBOARD -fork")
